...
import { FileText, Award, Landmark, ShieldCheck, Calendar, Lock } from "lucide-react";
    ...
    id: {
      ...
      docs: {
        akta: {
          ...
          desc: "Akta pendirian badan hukum Perseroan Terbatas PT Tembus Abadi Makmur yang mencatat modal dasar, struktur pemegang saham, dan bidang usaha utama perusahaan.",
        },
        sk: {
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-stretch">
          ...
          <div className="lg:col-span-7 flex">
            <div className="relative group w-full rounded-2xl glass-card p-6 sm:p-10 flex flex-col justify-between overflow-hidden">
              ...
              <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 text-white/2 select-none pointer-events-none">
