                  ...
                  <div className="relative glass-card rounded-2xl p-8 sm:p-10 flex flex-col justify-between items-start w-full h-full overflow-hidden">
                    ...
                    <div className="absolute inset-0 z-0">
                      <Image
                        ...
                        alt={val.title}
                        fill
                        className="object-cover opacity-30 group-hover:scale-105 group-hover:opacity-50 transition-all duration-700 pointer-events-none mix-blend-overlay"
                      />
                    ...
                    <div className="flex justify-between items-start w-full mb-8">
                      {/* Icon container */}
                      <div className={`inline-flex items-center justify-center p-3 rounded-xl bg-white/10 backdrop-blur-md border border-white/20 text-accent-orange group-hover:scale-110 transition-transform shadow-[0_4px_12px_rgba(0,0,0,0.1)]`}>
