        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 mb-28">
          ...
          <div className="lg:col-span-6 flex flex-col h-full">
            ...
            <div className="relative flex-1 flex flex-col gap-5 sm:gap-6">
              ...
              {/* Website */}
              <div className="flex gap-4 sm:gap-5 p-5 sm:p-6 rounded-xl bg-[#2a170b] border border-black hover:border-accent-orange/30 hover:bg-zinc-800 transition-all shadow-sm">
                <div>
                  <h4 className="text-sm sm:text-base font-bold text-accent-orange sm:text-white uppercase tracking-wider mb-2">{t.website}</h4>
                  <div className="flex flex-col gap-1.5">
                    <a href="https://www.tembusabadimakmur.com" target="_blank" rel="noopener noreferrer" className="text-zinc-200 font-medium text-sm sm:text-base hover:text-accent-orange transition-colors">
                      www.tembusabadimakmur.com
                    </a>
                    <a href="https://www.tembusdigital.com" target="_blank" rel="noopener noreferrer" className="text-zinc-200 font-medium text-sm sm:text-base hover:text-accent-orange transition-colors">
                      www.tembusdigital.com
                    </a>
                    <a href="https://www.tembusdigital.studio" target="_blank" rel="noopener noreferrer" className="text-zinc-200 font-medium text-sm sm:text-base hover:text-accent-orange transition-colors">
                      www.tembusdigital.studio
                    </a>
                  </div>
                </div>
              </div>
          ...
          <div className="lg:col-span-6 flex flex-col h-full">
            ...
            <div className="bg-[#1c100b] border border-[#2a170b] rounded-2xl p-8 sm:p-10 relative flex-1">
