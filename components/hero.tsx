...
export default function Hero({ lang }: HeroProps) {
  const content = {
    id: {
      ...
      subtitle: "PT. Tembus Abadi Makmur (TAM) menghadirkan solusi konstruksi, trading, dan interior yang tepat mutu, tepat biaya, dan tepat waktu.",
      ctaPrimary: "Memulai",
    },
    en: {
      title: "Building Trust with Outstanding Quality",
      subtitle: "PT. Tembus Abadi Makmur (TAM) delivers construction, trading, and interior solutions with the right quality, cost, and schedule.",
    ...
    <div id="home" className="relative min-h-screen flex flex-col justify-center items-center overflow-hidden bg-background bg-grid-lines pt-20">
      ...
      <div className="relative max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center flex flex-col items-center justify-center z-10">
        ...
        <motion.h1
          ...
          className="text-2xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-bold tracking-tight text-white font-poppins leading-[1.1] whitespace-nowrap"
        >
